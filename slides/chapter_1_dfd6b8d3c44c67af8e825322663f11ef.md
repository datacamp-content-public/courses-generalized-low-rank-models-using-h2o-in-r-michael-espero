...
`@script`
In the best of cases, financial applications that drop observations with missing values are **inefficient**; In the worst of cases, this heuristic is **biasing inference**.
...
- Problems with measurement, data storage, and the updating of detailed information on multiple economic indicators

`@script`
A number of factors may contribute to missing data in finance. Economic development may play a role as omission of certain information may be common in developing nations relative to wealthy, democratic places. 
