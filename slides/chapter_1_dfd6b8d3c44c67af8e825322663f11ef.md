...
plot_missing(finance_train_reconstructed)
```
...
## [Show GLRM's Effectiveness for Data Imputation of Mixed Values]
...
`@citations`
(To be replaced with visualization based on data used for lesson.)
